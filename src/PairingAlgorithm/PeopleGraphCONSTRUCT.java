...
public class PeopleGraphCONSTRUCT {

    private Vector<Vector<Person>> peopleGraph = new Vector<Vector<Person>>();
    private static int differenceOfSums;

    public PeopleGraphCONSTRUCT(PeopleGenerator peopleGenerator){
        this(peopleGenerator.getMalePeople(), peopleGenerator.getFemalePeople());
    }

    public PeopleGraphCONSTRUCT(PeopleVector malePeople, PeopleVector femalePeople){
